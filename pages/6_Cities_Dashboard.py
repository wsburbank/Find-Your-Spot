...
column_config = {
    ...
    "median_aqi": st.column_config.NumberColumn(format="%d"),
    "pct_good_days": st.column_config.NumberColumn(format="%.1f%%"),
    "days_unhealthy_total": st.column_config.NumberColumn(format="%d"),
    "police_spending_pc": st.column_config.NumberColumn(format="$%d"),
    "fire_spending_pc": st.column_config.NumberColumn(format="$%d"),
    "parks_spending_pc": st.column_config.NumberColumn(format="$%d"),
    "roads_spending_pc": st.column_config.NumberColumn(format="$%d"),
    "total_revenue_pc": st.column_config.NumberColumn(format="$%d"),
}
